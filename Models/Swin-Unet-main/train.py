...
parser.add_argument('--patch_size', type=int, default=224, help='Patch size for patch-based training')
parser.add_argument('--patch_stride', type=int, default=224, help='Stride for patch-based training')
...
if __name__ == "__main__":
    ...
    # Only use dataset_config for non-UDIADS_BIB datasets
    if args.dataset.lower() != "udiads_bib":
        dataset_config = {
            args.dataset: {
