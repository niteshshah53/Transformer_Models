...
#SBATCH --output=./All_Results_with_No_FocalLoss/missformer/UDIADS_BIB_FS/train_test_all_%j.out
#SBATCH --error=./All_Results_with_No_FocalLoss/missformer/UDIADS_BIB_FS/train_test_all_%j.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
for MANUSCRIPT in "${MANUSCRIPTS[@]}"; do
    ...
    python3 train.py \
        ...
        --base_lr 0.0002 \
        --patience 30 \
        --output_dir "./All_Results_with_No_FocalLoss/missformer/UDIADS_BIB_FS/udiadsbib_patch224_missformer_${MANUSCRIPT}"
